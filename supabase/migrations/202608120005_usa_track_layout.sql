-- Update new races to the image-calibrated USA starter course.
-- The UI supplies the image-free presentation centerline when older snapshots
-- do not contain visual data; these numeric values are authoritative for rules.
